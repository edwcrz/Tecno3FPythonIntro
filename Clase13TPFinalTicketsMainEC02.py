...
from Clase13TPFinalTicketsIngresarTicketEC02 import ingresar_ticket
from Clase13TPFinalTicketsLeerTicketEC02 import leer_ticket
from Clase13TPFinalTicketsMostrarTicketEC02 import mostrar_tickets
from Clase13TPFinalTicketsSalirTicketEC02 import salir_ticket
from Clase13TPFinalTicketsValidarTicketEC02 import validar_ticket_entero

"""
Comentarios del profesor Gabriel Sebastian Roman
...
while salir == False:
    ...
    if ingreso_pantalla_inicial == str(1) and salir == False:
        ...
        ticket= leer_ticket (ticket_leido, tickets)
        ...
        ticket_list = mostrar_tickets(tickets)
